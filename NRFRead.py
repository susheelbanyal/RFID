'''
This file will read the signals from NRF2401 (arduino) and play the video according to the data received
'''
...
def playVideo(id):
	...
	VIDEO_PATH = Path("/home/pi/Desktop/NRF24L01/videos/" + id + ".mp4")
